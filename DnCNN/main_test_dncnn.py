...
def main():
    ...
    parser.add_argument('--x8', type=bool, default=True, help='x8 to boost performance')
    ...
    for idx, img in enumerate(L_paths):
        ...
        if not args.x8:
            ...
            img_E = utils_model.test_mode(model, img_L_device, mode=3)
    ...
    if need_H:
        ...
        logger.info('Average PSNR/SSIM(RGB) - {} - PSNR: {:.2f} dB Std {}; SSIM: {:.4f} Std{}'.format(result_name, ave_psnr, std_psnr, ave_ssim, std_ssim))
